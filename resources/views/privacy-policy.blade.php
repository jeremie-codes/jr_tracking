                            ...
                            <ul class="mainmenu">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="axil-submenu">
                                        ...
                                        <li><a href="{{ route('articles') }}">Shop no Sidebar</a></li>
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <div class="axil-privacy-policy">
                            <span class="policy-published">This Privacy policy was published on February 26th,
                                2022.</span>
        ...
        <div class="header-search-wrap">
            ...
            <div class="card-body">
                <div class="search-result-header">
                    ...
                    <a href="{{ route('articles') }}" class="view-all">View All</a>
                </div>
