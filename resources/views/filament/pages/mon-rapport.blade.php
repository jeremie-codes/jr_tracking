            ...
            <table class="table-auto overflow-x-scroll bg-white dark:bg-gray-900 border dark:border-gray-700 mt-2 mx-0" style="width: 100%">
                <thead>
                    <tr class="bg-gray-200 dark:bg-gray-700">
                        <th class="px-4 py-2 border dark:border-gray-800" rowspan="2">Libellé</th>
                        <th colspan="{{ count($this->devises) }}" class="px-4 py-2 border dark:border-gray-800 text-center">Entrée</th>
                        <th colspan="{{ count($this->devises) }}" class="px-4 py-2 border dark:border-gray-800 text-center">Balance</th>
                        <th colspan="{{ count($this->devises) }}" class="px-4 py-2 border dark:border-gray-800 text-center">Sortie</th>
                    </tr>
                    <tr class="">
                        ...
                        <tr>
                            ...
                            @if ($row === 0)
                                <td rowspan="{{ count($ecritures) }}" class="px-4 py-2 border dark:border-gray-700"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="0.5" stroke="currentColor" class="size-2">
